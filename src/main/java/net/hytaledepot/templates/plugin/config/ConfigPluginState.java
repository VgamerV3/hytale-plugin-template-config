...
public final class ConfigPluginState {
  private final AtomicReference<ConfigPluginLifecycle> lifecycle = new AtomicReference<>(ConfigPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Config";
  private volatile String dataDirectory = "";

  public ConfigPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(ConfigPluginLifecycle next) {
    lifecycle.set(next);
  }
